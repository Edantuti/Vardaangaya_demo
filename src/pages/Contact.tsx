        ...
        <>
            <section className="h-screen">
                ...
                <div className="text-center my-10 w-10/12 mx-auto">
                    ...
                    <div className="text-[12px] md:text-md text-center grid grid-flow-col gap-5 w-auto mx-auto my-5 uppercase font-medium">  <a href="tel:+916203188133" className="p-3 border-2 border-black hover:bg-black hover:text-white transition-all ">Phone</a><a href="mailto:contact@vardaangaya.com" className="p-3 border-2 border-black hover:bg-black hover:text-white transition-all hover:pb-1">contact@vardaangaya.com</a><a href="mailto:vardaangaya@gmail.com" className="p-3 border-2 border-black hover:bg-black hover:text-white transition-all hover:pb-1">vardaangaya@gmail.com</a></div>
                    <Marquee pauseOnHover className="flex">
                        <img src={Image1} alt="hospital image" className="h-96 m-4 rounded"/>
                        <img src={Image2} alt="hospital image" className="h-96 m-4 rounded"/>
                        <img src={Image3} alt="hospital image" className="h-96 m-4 rounded"/>
                        <img src={Image4} alt="hospital image" className="h-96 m-4 rounded"/>
                        <img src={Image5} alt="hospital image" className="h-96 m-4 rounded"/>
                        <img src={Image6} alt="hospital image" className="h-96 m-4 rounded"/>
                        <img src={Image7} alt="hospital image" className="h-96 m-4 rounded"/>
                        <img src={Image8} alt="hospital image" className="h-96 m-4 rounded"/>
                        <img src={Image9} alt="hospital image" className="h-96 m-4 rounded"/>
                        <img src={Image11} alt="hospital image" className="h-96 m-4 rounded"/>
                    </Marquee>
                </div>
            </section>
