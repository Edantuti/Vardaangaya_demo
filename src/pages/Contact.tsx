        ...
        <>
            <section className="max-h-full min-h-screen">
                ...
                <Marquee pauseOnHover speed={100} className="flex md:max-h-96 sm:max-h-96 overflow-hidden md:my-10 my-0 z-0">
                        ...
                        <img src={Image4} alt="hospital image" className="md:h-96 max-h-60 m-4 rounded"/>
                        <img src={Image5} alt="hospital image" className="md:h-96 max-h-60 m-4 rounded"/>
                        <img src={Image6} alt="hospital image" className="md:h-96 max-h-60 m-4 rounded"/>
                        <img src={Image7} alt="hospital image" className="md:h-96 max-h-60 m-4 rounded"/>
                        <img src={Image8} alt="hospital image" className="md:h-96 max-h-60 m-4 rounded"/>
                        <img src={Image9} alt="hospital image" className="md:h-96 max-h-60 m-4 rounded"/>
                        <img src={Image11} alt="hospital image" className="md:h-96 max-h-60 m-4 rounded"/>
                        <img src={KneeReplacement1} alt="hospital image" className="md:h-96 max-h-60 m-4 rounded"/>
                        <img src={KneeReplacement2} alt="hospital image" className="md:h-96 max-h-60 m-4 rounded"/>
                        <img src={KneeReplacement3} alt="hospital image" className="md:h-96 max-h-60 m-4 rounded"/>
                        <img src={KneeReplacement4} alt="hospital image" className="md:h-96 max-h-60 m-4 rounded"/>
                        <img src={HipJoint1} alt="hospital image" className="md:h-96 max-h-60 m-4 rounded"/>
