...
PostMap.set('total hip and knee replacement', {
  ...
  description:
    'What is Total Hip and Knee Replacement?, What are the methods that undergo, during the process?.',
  content: [
...
PostMap.set('arthroscopy & sports surgery', {
  ...
  description:
    'What is Arthroscopy & Sports Surgery?, What are the methods that undergo, during the process?.',
  content: [
...
PostMap.set('spine and backache surgery', {
  ...
  description:
    'What is Spine and Backache Surgery?, What are the methods that undergo, during the process?.',
  content: [
